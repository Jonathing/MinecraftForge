...
public abstract class JarJarMetadataOptions extends DefaultTask {
    ...
    @TaskAction
    protected void exec() {
        record ForgeLocaterOptions(String resource, String layer, String id, ContainedJarMetadata meta) { }
        ...
        try {
            Files.writeString(
                ...
                GSON.toJson(jars, new TypeToken<List<ForgeLocaterOptions>>() { }.getType())
            );
        } catch (IOException e) {
