package net.minecraftforge.forge.gradle.properties;
 ...
 * <p>This does the same thing, as well as sorting alphabetically.
 * <p>It also ignores all comments. We can add them latter if someone cares.
 *
 * @see <a href="https://github.com/eclipse/buildship/blob/5b2c7fca7fa86cd74d71b3c099c7b1559eba038e/org.eclipse.buildship.core/src/main/java/org/eclipse/buildship/core/internal/configuration/PreferenceStore.java#L238">PreferenceStore:238</a>
 */
public class CleanProperties extends Properties {
    ...
    public Set<Map.Entry<Object, Object>> entrySet() {
        Set<Map.Entry<Object, Object>> ret = new TreeSet<>(Comparator.comparing(l -> ((String) l.getKey())));
